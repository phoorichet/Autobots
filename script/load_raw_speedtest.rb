...
APP_FILE_DIRECTORY = "./data/export/speedtest.csv"
APP = "ping"
MODEL = RawSpeedtest
...
Dir.glob(APP_FILE_DIRECTORY) do |file|
  puts "reading... #{file}"
  count_record = 0
  needed_attributes = ["imei", "imsi", "technology", "datetime", "download", "upload", "latency", "server_id", "server_name", "avg_ecio", "avg_rssi", "mcc", "mcc", "lac", "cell_id", "script_name", "operator", "result", "set_server_id", "set_server_name", "apn"] 
