...
(function(){
  ...
  var module = angular.module('autobot.linechartlocation.controllers', ['autobot.api.services', 'autobot.filter.services']);

  module.controller('LinechartLocationCtrl', ['$scope', 'Api', 'Filters', 
    function($scope, Api, Filters){
      ...
      $scope.initialize = function(element, attributes){
        ...
        $scope.panel = {
          ...
          rnc_options: [
            {name: "3RNCCWD2H", ticked: true},
            {name: "3RNCNMA4Z", ticked: true},
            {name: "3RNCCMI4H", ticked: true},
            {name: "3RNCAYA1Z", ticked: true},
            {name: "3RNCPTY1N", ticked: true},
            {name: "3RNCAYA2Z", ticked: true},
            {name: "3RNCCWD1H", ticked: true},
            {name: "3RNCSUK1H", ticked: true},
            {name: "3RNCPLK2H", ticked: true},
            {name: "3RNCSNI2H", ticked: true},
            {name: "3RNCCBI1N", ticked: true},
            {name: "3RNCCMI2H", ticked: true},
            {name: "3RNCPLK1H", ticked: true},
            {name: "3RNCHYI4H", ticked: true},
            {name: "3RNCNMA7Z", ticked: true},
            {name: "3RNCKKN5Z", ticked: true},
            {name: "3RNCBPL1H", ticked: true},
            {name: "3RNCCMI3H", ticked: true},
            {name: "3RNCNMA5Z", ticked: true},
            {name: "3RNCNPT1Z", ticked: true},
            {name: "3RNCNMA1Z", ticked: true},
            {name: "3RNCBPL2H", ticked: true},
            {name: "3RNCNPT2Z", ticked: true},
            {name: "3RNCKKN6Z", ticked: true},
            {name: "3RNCAYA3Z", ticked: true},
            {name: "3RNCBPL3H", ticked: true},
            {name: "3RNCCBI2N", ticked: true},
            {name: "3RNCHYI3H", ticked: true},
            {name: "3RNCSUK3H", ticked: true},
            {name: "3RNCNMA6Z", ticked: true},
            {name: "3RNCCMI1H", ticked: true},
            {name: "3RNCKKN2Z", ticked: true},
            {name: "3RNCSNI1H", ticked: true},
            {name: "3RNCPTY2N", ticked: true},
            {name: "3RNCHYI2H", ticked: true},
            {name: "3RNCCBI3N", ticked: true},
            {name: "3RNCNPT3Z", ticked: true},
            {name: "3RNCPTY3N", ticked: true},
            {name: "3RNCHYI1H", ticked: true},
            {name: "3RNCSUK2H", ticked: true},
            {name: "3RNCKKN1Z", ticked: true},
            {name: "3RNCTWA2H", ticked: true},
            {name: "3RNCNMA2Z", ticked: true},
          ],
          stack_options: [ 
            {key: 'None', value: null}, 
      ...
      $scope.refreshRncFilter = function(){
        $scope.rnc = $scope.panel.rnc_options
                    .filter(function(d){ return d.ticked === true; })
                    .map(function(d){ return d.name });
      }
      ...
      $scope.setRncFilter = function(rnc){
        $scope.rnc = rnc === "All" ? null : rnc;
      }
      ...
      $scope.$watchCollection('rnc', function(newValue, oldValue){
        if(newValue !== oldValue){
          $scope.updateViz(newValue);
        }
      });      
      ...
      $scope.updateViz = function(filters){
        ...
        $scope.serviceApi.mapreduce_join_mslocation(submitFilters, function(data){
          ...
          var y = d3.scale.linear() // .domain(d3.extent(data, function(d){ return d[attr]; }))
          ...
          function mousemove() {
            ...
            if(data.length > 0){
              ...
              d3.selectAll(".focus-legend")
                  ...
                  .classed("legend-below-threshold", function(d) { if (d.values) return d.values.y < threshold ? true : false ; });;
