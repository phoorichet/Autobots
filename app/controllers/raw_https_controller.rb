class RawHttpsController < ApplicationController
  ...
  private
    ...
    def raw_http_params
      params.require(:raw_http).permit(:connecting_time_1, :time_to_first_byte_1, :result_1, :result_detail_1, :imei, :imsi, :script_name, :service, :serviceinfo, :avg_rssi, :avg_rxlev, :avg_ecio, :cell_id, :lac, :start_time, :stop_time, :duration_time, :data_download_transfer, :max_download, :max_download_overall, :min_download, :throughput_download_ip, :throughput_download_app, :throughput_download_rlc, :result, :lat, :lon, :apn)
    end
end
