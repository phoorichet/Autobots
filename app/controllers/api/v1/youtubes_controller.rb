  ...
  module V1
    class YoutubesController < ApplicationController
      ...
      def mapreduce_join_mslocation
        ...
        select_list = metric.selectfs.map{|d| "#{RawYoutube.table_name}.#{d.field}"}
        ...
        results = results.joins("LEFT JOIN #{MsLocation.table_name} ON #{RawYoutube.table_name}.imei = #{MsLocation.table_name}.imei")
